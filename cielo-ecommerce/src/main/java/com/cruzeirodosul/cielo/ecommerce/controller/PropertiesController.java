...
public class PropertiesController {
	...
	@RequestMapping(value = "readProperties", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public String readProperties(Map<String, Object> model) {
